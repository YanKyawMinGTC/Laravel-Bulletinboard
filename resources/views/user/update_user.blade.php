      ...
      <div class="card">
        ...
        <div class="row">
          <div class="card-body col-md-9">
            <form method="POST" action="{{ route('users.update',$users->id) }}"> @csrf @method('PATCH')<div
                class="form-group row">
                <label for="name" class="col-md-4 col-form-label text-md-right">Name</label>
                <div class="col-md-6">
                  <input id="nameid" type="text" class="form-control @error('name') is-invalid @enderror" name="name"
              ...
              </div> @endif <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input type='text' name="dob" id="dob" class="form-control" value="{{$users['dob']}}">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="profile" type="file" onchange="loadFile(event)" class="form-control mb-3" name="profile">
                </div>
              </div>
              <div class="d-flex justify-content-center">
                <img src="/image/default_img.png" class="default_img " width="200">
              </div>
          ...
          <div class="form-group col-md-2">
            <div class="mt-5 mr-5 w-100 ">
              <img src="/image/default_img.png" class="default_img" alt="dog img" style="width:100%;">
            </div>
          </div>
        </div>
      </div>
